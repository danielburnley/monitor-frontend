import GenerateHEReturnUISchema from ".";

describe("GenerateHEReturnUISchema", () => {
  ...
  describe("As a Homes England user", () => {
    ...
    describe("Example one", () => {
      beforeEach(() => {
        ...
        useCase = new GenerateHEReturnUISchema(generateUISchemaSpy);
      });
      ...
      describe("Writable", () => {
        it("Enables fields marked as Homes England writable", () => {
          let schema = {
            type: "object",
            properties: {
              a: { type: "string", heWritable: true }
            }
          };
          let response = useCase.execute(schema);
          expect(response).toEqual({ a: { "ui:field": "field" } });
        ...
        it("Does not modify arrays marked as writable by Homes England", () => {
          let schema = {
            type: "object",
            properties: {
              a: {
