import UpdateClaim from ".";

describe("UpdateClaim", () => {
  let claimGatewaySpy, presenterSpy;

  function getUseCase(successfulUpdate, id, projectId) {
    claimGatewaySpy = {
      update: jest.fn(() => ({ success: successfulUpdate, projectId, id }))
    };

    return new UpdateClaim(claimGatewaySpy);
  }
  ...
  describe("Example one", () => {
    ...
    describe("With successful update", () => {
      ...
      it("Passes the data to the gateway", () => {
        expect(claimGatewaySpy.update).toBeCalledWith(9, 1, { cats: "meow" });
      });
  ...
  describe("Example two", () => {
    ...
    describe("With successful update", () => {
      ...
      it("Passes the data to the gateway", async () => {
        expect(claimGatewaySpy.update).toBeCalledWith(3, 2, { dogs: "woof" });
      });
