...
storiesOf("Sidebar", module)
  .add("With a single item without children", () => (
    <Sidebar
      items={{ cats: { title: "Cats", subSection: "Sheep" } }}
  ...
  .add("With two items without children", () => (
    <Sidebar
      items={{
        cats: { title: "Cats", subSection: "Cows" },
        dogs: { title: "Dogs", subSection: "Sheep" }
      }}
      updateParentForm={e => console.log("updateParentForm " + e)}
    />
  ))
    ...
    <Sidebar
      items={{
        cats: {
          title: "Cats",
          subSection: "In Hats",
          children: { noises: { title: "Noises", subSection: "Dogs" } }
        },
        dogs: {
          title: "Dogs",
          subSection: "In Shoes",
  ...
  .add("With a selected item", () => (
    <Sidebar
      ...
      updateParentForm={e => console.log("updateParentForm " + e)}
      selectedFormSection={"noises"}
      selectedFormItemIndex={1}
    />
  ));
